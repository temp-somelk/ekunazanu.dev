...
This another one of the experimental posts. Now, I like music — a lot of people do. I also like math — a lot of people do **not**. It's time to mix both these arts. It's time to experiment and create.

I do still want it to be a little bit of an explainer post — music theory is interesting. But feel free to skip it and go to the [generator](#Playground) directly if you want.

## Music Theory
 
To create music, it helps to have an understanding of what is sound and what makes certains sounds more pleasant than others.

![airparts](airparticles)

These are air molecules. A vibrating or oscilating object can cause them to vibrate and oscillate as well, creating pressure waves. The vibrating air particles are sound — technically, the transmission medium could be a liquid or solid too — in this case the transmission medium is air. If the air pressure at a point is plotted with respect to time, then the resulting graph is a wave.
